"""
Django settings for xiaoshenlong_wms project.
小神龙仓库管理系统 - 数据持久化改进版
"""
...
SECRET_KEY = 'django-insecure-xiaoshenlong-wms-2024-dev-only'
...
ROOT_URLCONF = 'xiaoshenlong_wms.urls'
...
WSGI_APPLICATION = 'xiaoshenlong_wms.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'xiaoshenlong-wms-cache',
    }
}
